 ...
 */
	...
	$minimum_wordpress_version = '3.3';
	//global constants
	define("WPComcar_PLUGINVERSION","0.20.1");
	...
	// Check that we are in the right version of wordpress
	global $wp_version;

	if ( version_compare( $wp_version, $minimum_wordpress_version,"<" ) ){
		$WPComcar_exitMsg + "Comcar plugins requires Wordpress" . $minimum_wordpress_version  . "or newer.";
