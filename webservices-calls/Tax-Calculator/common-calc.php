<?php
	...
	try {
		...
		$WPComcar_resultsJS = $WPComcar_ws->GetJS($WPComcar_pubhash, $WPComcar_clk, 4, '');


		$WPComcar_resultsHTML = $WPComcar_ws->GetHTML($WPComcar_pubhash, $WPComcar_clk, 4, "", $WPComcar_formData);
