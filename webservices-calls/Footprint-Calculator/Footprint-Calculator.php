<?php
	...
	try {
		...
		$WPComcar_ws = new SoapClient($WPComcar_services['footprint'], array('cache_wsdl' => 0));
		...
		$WPComcar_resultsHTML = $WPComcar_ws->GetHTML($WPComcar_pubhash, $WPComcar_clk, 'Footprint-Calculator.php', $WPComcar_jsnDataAndConfig);
	...
	$WPComcar_pageTitle = 'CO2 Footprint Calculator';
	include(WPComcar_WEBSERVICESCALLSPATH.'Carmen-Data-Web-Services-Template/template.php');
?>
