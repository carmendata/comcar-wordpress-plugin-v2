<?php
	...
	try {
		...
		$WPComcar_resultsJS = fixForSsl($WPComcar_ws->GetJS($WPComcar_pubhash, $WPComcar_clk));
		$WPComcar_resultsHTML = fixForSsl($WPComcar_ws->GetHTML($WPComcar_pubhash, $WPComcar_clk, 'Footprint-Calculator.php', $WPComcar_jsnDataAndConfig));
