<?php
    ...
    try {
        ...
        // $WPComcar_actionName =  $WPComcar_arrOptions['fuel_benefit_check_subpage_model'] 
        ...
        $WPComcar_arrOptions = get_option( "WP_plugin_options_fuel_benefit_check" );
        $WPComcar_resultsHTML = fixForSsl( $WPComcar_ws->GetHTML( $WPComcar_pubhash, $WPComcar_clk ));
