...
<?php
	...
	if( strlen($WPComcar_msg) ){
		...
		$WPComcar_theResultOfTheWebservice .= $WPComcar_resultsCSS . $WPComcar_resultsJS . '<div id="WPComcar_container">' .$post->post_content. urldecode($WPComcar_resultsHTML) . '</div>';
	}
